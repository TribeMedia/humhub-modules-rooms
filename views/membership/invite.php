    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title"
                id="myModalLabel"><?php echo Yii::t('RoomsModule.views_room_invite', '<strong>Invite</strong> members'); ?></h4>
        </div>
        <div class="modal-body">
                ...
                <div class="text-center">
                    <ul id="tabs" class="nav nav-tabs tabs-center" data-tabs="tabs">
                        <li class="active tab-internal"><a href="#internal"
                                                           data-toggle="tab"><?php echo Yii::t('RoomsModule.views_room_invite', 'Pick users'); ?></a>
                        </li>
                        <li class="tab-external"><a href="#external"
                                                    data-toggle="tab"><?php echo Yii::t('RoomsModule.views_room_invite', 'Invite by email'); ?></a>
                        </li>
                    </ul>
                </div>
                <br/>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="internal">
                    ...
                    <?php echo Yii::t('RoomsModule.views_room_invite', 'To invite users to this room, please type their names below to find and pick them.'); ?>
                    ...
                    $this->widget('application.modules_core.user.widgets.UserPickerWidget', array(
                        ...
                        'attribute' => 'invite',
                        'placeholderText' => Yii::t('RoomsModule.views_room_invite', 'Add an user'),
                        'focus' => true,
                    ));
                    ?>
                ...
                <?php if (HSetting::Get('internalUsersCanInvite', 'authentication_internal')) : ?>
                    <div class="tab-pane" id="external">
                        <?php echo Yii::t('RoomsModule.views_room_invite', 'You can also invite external users, which are not registered now. Just add their e-mail addresses separated by comma.'); ?>
                        <br/><br/>

                        <div class="form-group">
                            <?php //echo $form->label($model, 'inviteExternal'); ?>
                            <?php echo $form->textArea($model, 'inviteExternal', array('class' => 'form-control', 'rows' => '3', 'id' => 'email_invite', 'placeholder' => Yii::t('RoomsModule.views_room_invite', 'Email addresses'))); ?>
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary"
                    data-dismiss="modal"><?php echo Yii::t('RoomsModule.views_room_invite', 'Close'); ?></button>
