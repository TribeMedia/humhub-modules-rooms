                        ...
                        <table width="540"  align="center" border="0" cellspacing="0" cellpadding="0" class="full-width" bgcolor="#ffffff" style="background-color:#ffffff;">
                            ...
                            <tr>
                             ...
                             <span style="color: #555555; font-weight: 300;">
                               <?php echo Yii::t('RoomsModule.views_mails_UserInviteRoom', 'You got a <strong>room</strong> invite'); ?>
                             </span>
                                                        </td>
                                                    </tr>
                                                </table>
                            ...
                            <tr>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" >
                                                    ...
                                                    <tr>
                                                        <td  style="font-size: 14px; line-height: 22px; padding-left: 50px; padding-right: 50px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:center; ">
                                                            ...
                                                            <!-- START: CONTENT -->
                                                            <?php echo Yii::t('RoomsModule.views_mails_UserInviteRoom', 'invited you to the room:'); ?>
                                                            <strong><?php echo CHtml::encode($roomName); ?></strong>
                                                            at <?php echo CHtml::encode(Yii::app()->name); ?>.<?php echo Yii::t('RoomsModule.views_mails_UserInviteRoom', '<br>A social network to increase your communication and teamwork.<br>Register now
                                                        to join this room.'); ?><br/>
                                                            &nbsp;
                                                            <!-- END: CONTENT -->
                                                        </td>
                                                    </tr>
                             ...
                             <span style="color: #ffffff; font-weight: 300;">
                               <a href="<?php echo Yii::app()->createAbsoluteUrl("user/auth/createAccount", array('token' => $token)); ?>" style="text-decoration: none; color: #ffffff; font-weight: 300;">
                                   <strong><?php echo Yii::t('RoomsModule.views_mails_UserInviteRoom', 'Sign up now'); ?></strong>
                               </a>
                             </span>
                                                        </td>
