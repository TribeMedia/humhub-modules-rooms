            ...
            $(this).fileupload({
                ...
                progressall: function (e, data) {
                    ...
                    if (data.result.files.error == true) {
                        ...
                        $('#room-menu img').attr('src', data.result.files.url + '&c=' + Math.random());
                        $('#room-profile-image').attr('src', data.result.files.url + '&c=' + Math.random());
                        $('#room-profile-image').addClass('animated bounceIn');
                    }
                ...
                $('#room-profile-image').removeClass('animated bounceIn');
            })
            ...
            $(this).fileupload({
                ...
                progressall: function (e, data) {
                    ...
                    if (data.result.files.error == true) {
                        ...
                        $('#room-banner-image').attr('src', data.result.files.url + '&c=' + Math.random());
                        $('#room-banner-image').addClass('animated bounceIn');
                    }
                ...
                $('#room-banner-image').removeClass('animated bounceIn');
            })
...
function resetProfileImage(jsonResp) {
    ...
    if (json.type == 'profile') {
        $('#room-menu img').attr('src', json.defaultUrl + '&c=' + Math.random());
        $('#room-profile-image').attr('src', json.defaultUrl + '&c=' + Math.random());
    } else if (json.type == "banner") {
        $('#room-banner-image').attr('src', json.defaultUrl + '&c=' + Math.random());
    }
